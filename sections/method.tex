...
\begin{figure*}
    \centering
    \includegraphics[width=1\linewidth]{figures/savnav-method}
...
that switches between Precision Navigation and Active Search.
...
\begin{itemize}
    ...
    \item
          State B (Active Search): Triggered when the target is only
