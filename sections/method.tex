...
\begin{figure*}
    ...
    \caption{\textbf{Overview of the SAVNav (Socially-Aware Audio-Visual Navigation) pipeline.}SAVNav audio-visual navigation pipeline with perception, SAVMap, and planning components.}
