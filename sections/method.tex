...
\begin{figure*}
    \centering
    \includegraphics[width=1\linewidth]{figures/savnav-method.png}
    \caption{SAVNav audio-visual navigation pipeline with perception, SAVMap, and planning components.}
