...
\begin{table}[t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{lccl}
			...
			\midrule
			Crowded Social      & 1--4        & LOS        & 1 SCG + 1 DP    \\
