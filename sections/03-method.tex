...
Vision-based social navigation relies on instantaneous LOS detections. SAVMap maintains three coupled states: anchoring confidence for audio-visual association, NLOS risk belief over topological nodes, and the resultant social cost field used by the SAVNav policy.
