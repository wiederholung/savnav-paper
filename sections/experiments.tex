...
The robot must navigate to a target sound source in an environment containing $N \in [1, 5]$ human agents. The soundscape includes 5 classes of \textit{Target Sounds} (e.g., Music, Water Running) and 2 classes of \textit{Distractors} (Footsteps, Chatter). 
