...
%   \fbox{\rule{0pt}{2in} \rule{0.9\linewidth}{0pt}}
   ...
   \caption{\textbf{Hearing Before Seeing.} Top: A standard vision-based robot fails to anticipate a pedestrian approaching from a blind corner, resulting in a collision or sudden stop. Bottom: Our SAVNav system utilizes acoustic cues to detect the non-line-of-sight (NLOS) footsteps. It generates a ``Hallucinated Cost Field'' (red zone) that extends through the wall, injecting virtual momentum into the planner to execute a smooth, socially compliant wide turn.}
   \label{fig:teaser}
\end{figure}
